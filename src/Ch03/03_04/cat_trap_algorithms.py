...
03_04 - Challenge: A depth-limited cat
        ...
        Go to line 318 for the challenge!
...
class CatTrapGame:
    ...
    def max_value(self, game, depth):
        ...
        Your task is to modify the following functions to upgrade the minimax and alpha-
        beta pruning algorithms to support depth-limited search.
        ...
        4) Replicate those additions in alpha_beta_max_value() and alpha_beta_min_value(). 
        5) If you're stuck, you may ask in the course's Q&A or consult the
           ...
           much of the fun.
        """
        # TODO: Remove the following 3 lines to enable your depth-limited implementation.
        ...
        # TODO: Add the condition of having reached self.max_depth to call the utility function.
        if not legal_moves: # Add the condition here.
            
            # TODO: If the max_depth was reached, set the self.reached_max_depth flag.
    ...
    def alpha_beta_max_value(self, game, alpha, beta, depth):
        ...
        """
        # TODO: Remove the following 3 lines to enable your deptyh-limited implementation.
        if self.max_depth < 10000:
            self.placeholder_warning()
            return self.random_cat_move(), 0
